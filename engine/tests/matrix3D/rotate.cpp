...
CTEST(matrixRotate, const) {
    auto const matrix1 = math::Matrix3D::rotateZ(math::Radian{M_PI});
...
CTEST(matrixRotate, pi) {
    auto matrix1 = math::Matrix3D::rotateZ(math::Radian{M_PI});
    ASSERT_FLOAT_EQUAL(-1, matrix1.r0c0);
    ASSERT_FLOAT_EQUAL(0, matrix1.r0c1);
    ASSERT_FLOAT_EQUAL(0, matrix1.r0c2);
    ASSERT_FLOAT_EQUAL(0, matrix1.r1c0);
    ...
    auto matrix2 = math::Matrix3D::rotateZ(math::Radian{M_PI / 2});
    ...
    auto matrix3 = math::Matrix3D::rotateZ(math::Radian{M_PI / 3});
    ...
    auto matrix4 = math::Matrix3D::rotateZ(math::Radian{M_PI / 4});
    ...
    auto matrix5 = math::Matrix3D::rotateZ(math::Radian{M_PI / -3});
    ...
    auto matrix6 = math::Matrix3D::rotateZ(math::Radian{M_PI / -4});
...
CTEST(matrixRotate, zero) {
    auto matrix1 = math::Matrix3D::rotateZ(math::Radian{0.0});
